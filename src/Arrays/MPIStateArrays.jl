...
"""
struct MPIStateArray{FT, V, DATN<:AbstractArray{FT,3}, DAI1, DAV,
  ...
  function MPIStateArray{FT, V}(mpicomm, DA, Np, nstate, numelem, realelems,
    ...
    new{FT, V, typeof(data), DAI1, DAV, Buf}(mpicomm, data, realdata,
...
function MPIStateArray{FT, V}(mpicomm, DA, Np, nstate, numelem;
                              realelems=1:numelem,
                              ghostelems=numelem:numelem-1,
                              vmaprecv=1:0,
                              vmapsend=1:0,
  ...
  MPIStateArray{FT, V}(mpicomm, DA, Np, nstate, numelem, realelems, ghostelems,
...
function Base.similar(Q::MPIStateArray{OLDFT, V}, ::Type{A}, ::Type{FT}; commtag=Q.commtag
                     ) where {A<:AbstractArray, FT<:Number, OLDFT, V}
  MPIStateArray{FT, V}(Q.mpicomm, A, size(Q.data)..., Q.realelems,
